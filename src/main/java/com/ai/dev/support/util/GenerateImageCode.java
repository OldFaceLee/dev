...
public class GenerateImageCode {
        ...
        public GenerateImageCode(int width, int height) {
            this.width = width;
            this.height = height;
            creatImage();
        }

        public GenerateImageCode(int width, int height, int codeCount) {
            this.width = width;
            this.height = height;
        ...
        public GenerateImageCode(int width, int height, int codeCount, int lineCount) {
            this.width = width;
            this.height = height;
            this.codeCount = codeCount;
